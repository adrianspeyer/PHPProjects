    ...
    $.fn.makeEditable = function (options) {
        ...
        function _fnApplyEditable(aoNodes) {
            ...
            var oDefaultEditableSettings = {
                ...
                "onsubmit": function (settings, original) {
                    var input = $("input,select,textarea,password", this);
                    sOldValue = original.revert;
                    sNewCellValue = $("input,select,textarea,password", $(this)).val();
                    if (input.length == 1) {
        ...
        function _fnOnRowAdded(data) {
            ...
            if (properties.fnOnNewRowPosted(data)) {
                ...
                $("input:text[rel],input:radio[rel][checked],input:hidden[rel],select[rel],password[rel],textarea[rel],span.datafield[rel]", oAddNewRowForm).each(function () {
