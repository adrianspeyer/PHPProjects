...
$.extend( $.expr[ ":" ], {
	...
	focusable: function( element ) {
		...
		return ( /input|select|textarea|password|button|object/.test( nodeName )
			? !element.disabled
			: "a" == nodeName
	...
	_create: function() {
		...
		this._renderAxis = function(target) {
			...
			for(var i in this.handles) {
				...
				if (this.elementIsWrapper && this.originalElement[0].nodeName.match(/textarea|input|select|password|button/i)) {
