...
CREATE DATABASE IF NOT EXISTS satisfy  DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_general_ci;
CREATE TABLE IF NOT EXISTS satisfy.st_results (
...
CREATE TABLE IF NOT EXISTS satisfy.st_ipcountry (
    `id` int(10) NOT NULL AUTO_INCREMENT,
    `loggedip` varchar(255) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS satisfy.st_user (
		`id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS satisfy.st_group (
 `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS satisfy.st_settings (
	`id` int(10) NOT NULL,
...
INSERT INTO satisfy.st_group (`groupname`, `export`, `print`, `clear`, `stats`, `userset`, `siteset`) VALUES
('Limited',0,0,0,0,0,0),
...
INSERT INTO satisfy.st_settings (`id`, `devmethod`, `popuptext`, `randomsurvey`, `delaytime`,`iprestrict`, `feedback`, `samail`, `piwikan`, `piwik_site_id`, `piwik_path`, `piwik_api`) VALUES
