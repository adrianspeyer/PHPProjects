...
<html>
<head>
<title>Feedback Story Setup</title>
</head>
<body>

<h1>Feedback Story </h1>
...
DB Prefix:<input type="text" name="prefix" value="st_" /> </p>
<?php
...
<input type="hidden" name="pkey" value='<?php $pkey = md5(uniqid()); echo $pkey;?>'  /> 
