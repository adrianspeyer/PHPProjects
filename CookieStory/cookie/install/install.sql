...
CREATE DATABASE IF NOT EXISTS cookies  DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_general_ci;
CREATE TABLE IF NOT EXISTS cookies.pw_cookiestory (
...
CREATE TABLE IF NOT EXISTS cookies.pw_cookiestats (
  `campaign_name` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS cookies.pw_authentication (
  `username` varchar(13) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS cookies.pw_ipcheck (
