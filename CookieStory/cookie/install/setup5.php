...
<body >
<!-- Panel -->
<div style="text-align: center;" id="toppanel">
<h1>User Registration Form</h1>
<br />
Create Your Super User for Cookie Story
<br /><br />
...
<form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
					...
					<input type="hidden" name="rolelevel" value="0"/>		

						<input type="submit" name="submit" value="Register"  />
						<div id="tips"><h4>Please note: Username should be alphanumeric less than 12 characters.</br>
						Password should be alphanumeric and greater than 8 characters.</h4></div>
						</form>			
